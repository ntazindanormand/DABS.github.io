...
<body>
  ...
  <div style="display:flex;justify-content: center;">
    ...
    &nbsp;&nbsp;&nbsp;-->
    <a href="?action=approve&id=<?php echo $appoid; ?>&name=<?php echo $pname; ?>&session=<?php echo $session; ?>&apponum=<?php echo $apponum; ?>" class="non-style-link">
    <button class="btn-primary-soft btn button-icon btn-approve" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;" onclick="showSuccessMessage()">
...
<script>
  ...
  <button class="btn-primary-soft btn button-icon btn-delete" style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px; background-color: red; color: white;">
