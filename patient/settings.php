...
if ($result && $result->num_rows > 0) {
    ...
    // Extract the required values from $userfetch
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="settings.php">&times;</a>
                        <div class="content">
                            Doctor Appointment Booking System<br>
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="National ID/Passport number" class="input-text" placeholder="National ID/Passport number Number" value="'.$nic.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="password" class="input-text" placeholder="Define  Password" required><br>
                                        </td>
                                    </tr><tr>
                                        <td class="label-td" colspan="2">
